...
public final class DownloadDataLine extends AbstractDataLine
    ...
    private static final String INVALID_STATE =
        GUIMediator.getStringResource("DOWNLOAD_STATUS_INVALID");
    ...
    private static final String[] INVALID_MESSAGE =
        { GUIMediator.getStringResource("DOWNLOAD_INVALID_EXPLAIN") }; 
    ...
    private static final String SEEDING =
    	GUIMediator.getStringResource("DOWNLOAD_STATUS_SEEDING");
    
    private static final String WAITING_FOR_TRACKER =
    ...
    public boolean isTooltipRequired(int col) {
        return _state == Downloader.INVALID;
    }
	...
	public String[] getToolTipArray(int col) {
		...
		synchronized(DOWNLOADER) {
			numChunks = CHUNKS + ": "+DOWNLOADER.getAmountVerified() / chunkSize +"/"+
                ...
                "/"+
				(DOWNLOADER.getContentLength() + chunkSize -1) / chunkSize +
				", "+chunkSize/1024+KB;
	...
	private void updateStatus() {
        ...
        case Downloader.PAUSED:
            ...
            break;
        case Downloader.INVALID:
            _status = INVALID_STATE;
            break;
        case Downloader.SEEDING:
        	_status = SEEDING;
        	break;
        case Downloader.WAITING_FOR_TRACKER:
        	_status = WAITING_FOR_TRACKER;
        	break;
		default:
			Assert.that(false,
