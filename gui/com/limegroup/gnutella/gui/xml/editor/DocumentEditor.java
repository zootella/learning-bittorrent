...
public class DocumentEditor extends MetaEditorPanel {
	...
	private void init() {
		...
		titleLabel = new JLabel(MetaEditorUtil.getStringResource(LimeXMLNames.DOCUMENT_TITLE));
		...
		mainConstr.insets = new Insets(5,10,0,2);
		mainConstr.gridy=2;
		topicLabel = new JLabel(MetaEditorUtil.getStringResource(LimeXMLNames.DOCUMENT_TOPIC));
		...
		mainConstr.gridy=4;
		licenseLabel = new JLabel(MetaEditorUtil.getStringResource(LimeXMLNames.DOCUMENT_LICENSE));
		...
		mainConstr.gridy=0;
		mainConstr.insets = new Insets(5,10,0,2);
		authorLabel = new JLabel(MetaEditorUtil.getStringResource(LimeXMLNames.DOCUMENT_AUTHOR));
		...
		mainConstr.insets = new Insets(5,10,0,2);
		mainConstr.gridy=2;
		licenseTypeLabel = new JLabel(MetaEditorUtil.getStringResource(LimeXMLNames.DOCUMENT_LICENSETYPE));
	...
	private void initLocalFields() {
		addComponent(LimeXMLNames.DOCUMENT_TITLE, titleTextField);
        addComponent(LimeXMLNames.DOCUMENT_TOPIC, topicTextField);
        addComponent(LimeXMLNames.DOCUMENT_AUTHOR, authorTextField);
        addComponent(LimeXMLNames.DOCUMENT_LICENSETYPE, licenseTypeComboBox);
        addComponent(LimeXMLNames.DOCUMENT_LICENSE, licenseTextField);
